...
* Structs  --  Line 141
* Classes  --  Line 296
* Global Variables  --  Line 659
* ASCII Rendering Methods  --  Line 670
* Controller Methods -- Line 836
* Gameplay Loop Method  --  Line 1052
* Invoked Methods  --  Line 1113
**/
...
let DEALER_NAME = "Jacob" //Dealer's name; can be changed to whatever is funniest at the moment.
  ...
  private func gameTurn(isPlayersTurn: Bool, advanceGame: Bool, clear : Bool = true, exitOnly : Bool = false)
  {
    ...
    **/
    private func loseGame(withBlackJack : Bool = false, hotExit : Bool = false)
    {
      ...
      inputController(controllerCase: hotExit ? 1 : 5, exitOnly: true)
    }
